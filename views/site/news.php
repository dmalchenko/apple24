...
<section class="content_block pager">
    <div class="container">
        ...
        <div class="news">
            <div class="block">
                <a href="/viewer?id=1" alt="Скидка до 80% на аксессуары"
                   title="Скидка до 80% на аксессуары">
                    <div class="image"
                         style="background-image:url('/uploads/news/267x210/550e1238f9ef3213fa55e823f4ce37a4.jpg')">
                        <div class="date">
                            <span> 27 </span><span> января </span><span> 2017 </span></div>
                    </div>
                </a>
                <h2><a href="/viewer?id=1">Скидка до 80% на аксессуары</a></h2>
                <!--                <div class="date">--><!--</div>-->
                ...
                <a href="/viewer?id=1" class="link">Подробнее</a>
            </div>
            <div class="block">
                <a href="/viewer?id=2" alt="С новым 2017 годом" title="С новым 2017 годом">
                    <div class="image"
                         style="background-image:url('/uploads/news/267x210/2a4cb8d053f557e34f7fd38bcd1c0d7e.jpg')">
                        <div class="date">
                            <span> 31 </span><span> декабря </span><span> 2016 </span></div>
                    </div>
                </a>
                <h2><a href="/viewer?id=2">С новым 2017 годом</a></h2>
                <!--                <div class="date">--><!--</div>-->
                ...
                <a href="/viewer?id=2" class="link">Подробнее</a>
            </div>
            <div class="block">
                <a href="/viewer?id=3" alt="iPhone 7 - все по новому"
                   title="iPhone 7 - все по новому">
                    <div class="image"
                         style="background-image:url('/uploads/news/267x210/3310ea26b682c219dba489babc5fcfdc.jpg')">
                        <div class="date">
                            <span> 22 </span><span> сентября </span><span> 2016 </span></div>
                    </div>
                </a>
                <h2><a href="/viewer?id=3">iPhone 7 - все по новому</a></h2>
                <!--                <div class="date">--><!--</div>-->
                ...
                <a href="/viewer?id=3" class="link">Подробнее</a>
            </div>
            <div class="block">
                <a href="/viewer?id=4" alt="С новым 2016 годом" title="С новым 2016 годом">
                    <div class="image"
                         style="background-image:url('/uploads/news/267x210/d02c011e86e7d1e84341b6e1422ec042.jpg')">
                        <div class="date">
                            <span> 30 </span><span> декабря </span><span> 2015 </span></div>
                    </div>
                </a>
                <h2><a href="/viewer?id=4">С новым 2016 годом</a></h2>
                <!--                <div class="date">--><!--</div>-->
                ...
                <a href="/viewer?id=4" class="link">Подробнее</a>
            </div>
            <div class="block">
                <a href="/viewer?id=5" alt="Супер Акция 1+1!" title="Супер Акция 1+1!">
                    <div class="image"
                         style="background-image:url('/uploads/news/267x210/7fb1d72a9eeb423eab934b47e4276eeb.jpg')">
                        <div class="date">
                            <span> 7 </span><span> мая </span><span> 2015 </span></div>
                    </div>
                </a>
                <h2><a href="/viewer?id=5">Супер Акция 1+1!</a></h2>
                <!--                <div class="date">--><!--</div>-->
                ...
                <a href="/viewer?id=5" class="link">Подробнее</a>
            </div>
            <div class="block">
                <a href="/viewer?id=6" alt="С новым 2015 годом" title="С новым 2015 годом">
                    <div class="image"
                         style="background-image:url('/uploads/news/267x210/25d8b079ca58e72a8e55865ecac7fb5d.jpg')">
                        <div class="date">
                            <span> 30 </span><span> декабря </span><span> 2014 </span></div>
                    </div>
                </a>
                <h2><a href="/viewer?id=6">С новым 2015 годом</a></h2>
                <!--                <div class="date">--><!--</div>-->
                ...
                <a href="/viewer?id=6" class="link">Подробнее</a>
            </div>
        </div>
    </div>
</section>
